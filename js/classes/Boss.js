Megaman.Boss = function (game, name) {
    ...
    _self.anim = _self.game.add.sprite(750, 550, 'boss');
    _self.anchor.set(1,1);
    _self.anim.animations.add('stand');
...
Megaman.Boss.prototype.create = function(x){
	...
	this.anim.animations.play('stand', 10, true);
	console.dir(this);
	this.shoot();
...
Megaman.Boss.prototype.shoot = function(x) {
	console.dir(this);	this.anim.loadTexture("bossShoot");
	this.anim.animations.play('stand', 10, true);
}
